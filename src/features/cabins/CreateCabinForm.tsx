...
import { FieldError, FieldErrors, FieldValues, Merge, useForm } from "react-hook-form";
    ...
    return (
      <Form onSubmit={handleSubmit(onSubmit, onError)}>
        ...
        <FormRow label="Discount" errorMessage={errors?.discount?.message}>
          <Input type="number" id="discount" defaultValue={0} {...register('discount',  {required: 'This field is required', validate: (value: number) => value <= getValues().regularPrice || 'Discount should be less than regular price'})} disabled={isCreating}/>
        </FormRow>
